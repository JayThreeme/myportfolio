...
const Introme = () => {
  return (
    <section className="relative w-full h-screen mx-auto z-0 bg-hero-pattern bg-cover bg-no-repeat bg-center">
      <div
        className={`${styles.padding} relative inset-0 top-[120px] mx-auto items-start flex flex-col xl:flex-row xl:px-56 `}
      >
